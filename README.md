...
[![Build](https://github.com/abhimoondra/mcp-go/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/abhimoondra/mcp-go/actions/workflows/ci.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/abhimoondra/mcp-go?cache)](https://goreportcard.com/report/github.com/abhimoondra/mcp-go)
[![GoDoc](https://pkg.go.dev/badge/github.com/abhimoondra/mcp-go.svg)](https://pkg.go.dev/github.com/abhimoondra/mcp-go)
...
import (
    ...
    "github.com/abhimoondra/mcp-go/mcp"
...
```bash
go get github.com/abhimoondra/mcp-go
```
